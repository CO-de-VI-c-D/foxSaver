...
Func _foxSaverInit()
	...
	If @error Then
		...
		If FileExists(@ScriptDir & '\FirefoxPortable\App\Firefox64\firefox.exe') Then
			$sFFExe = @ScriptDir & '\FirefoxPortable\App\Firefox64\firefox.exe'
			WinSetTitle($hGMain, '', $gTitle & " - FF: Portable")
			Return 1
		EndIf
